...
cnet_plotly(reactome_enrichment_result, showCategory = 3, foldChange   = NULL)
cnet_plotly(reactome_enrichment_result, showCategory = 4, foldChange   = NULL)
...
cnet_plotly(reactome_enrichment_result, showCategory = 3, foldChange   = NULL, is_kegg = TRUE)
...
png("output_test.png")
print(cnet_plotly(kegg_enrichment_result, showCategory = 3, foldChange   = NULL, is_kegg = TRUE))
dev.off()
cn <- cnet_plotly(kegg_enrichment_result, showCategory = 3, foldChange   = NULL, is_kegg = TRUE)

orca(cn, "output_test.svg")
export(cn, file = "test.png")
##################################################
# previous version
cnet_plotly <- function(enrichment_result, showCategory, foldChange=NULL, is_kegg=FALSE){
  gene_font_size = 8
